(function () {
  ...
  function assertNoCustomPromisify (func) {
    if (func[util.promisify.custom]) {
      throw new Error('Missing func[util.promisify.custom]')
    }
  }
  ...
  exports.wrapFsWithAsar = function (fs) {
    ...
    assertNoCustomPromisify(realpath)
    ...
    assertNoCustomPromisify(access)
    ...
    assertNoCustomPromisify(readFile)
    ...
    assertNoCustomPromisify(readdir)
